...
x2, y2, z2 = process_data(raw_data, 'CparY', 'CparX', 'PoutAvg')
x3, y3, z3 = process_data(raw_data, 'CparY', 'CparX', 'LE[0]')
#x4, y4, z4 = process_data(raw_data, 'CparY', 'CparX', 'LE[1]')
x5, y5, z5 = process_data(raw_data, 'CparY', 'CparX', 'xRMS[2]')
x6, y6, z6 = process_data(raw_data, 'CparY', 'CparX', 'xRMS[2]')
