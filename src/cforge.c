...
void file_tutorial() {
    ...
    printf("\t- outfile: The base name of the output files that will contains\n");
    ...
    printf("   the number of the set. For that, the 'f[]' and 'x[]' are declared adding\n");
    printf("   'i' in the array index. For example, for a system with 'dim = 2',\n");
    printf("   there will be 2 linearized equations in each set declared as f[dim*1 + i]\n");
    printf("   and f[dim*2 + i]. Now, for a system with 'dim = 3', there will be 3\n");
    printf("   linearized equations in each set declared as f[dim*1 + i], f[dim*2 + i]\n");
