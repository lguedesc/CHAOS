...
void forcedbasin(char *funcname, char* outputname, void (*edosys)(int, double *, double, double *, double *)) {
    ...
    const char *rawdir = "data/ForcBasin/out/";                                                            // Directory of output file
    char *dir = convert_dir(rawdir);
    const char *ext = ".csv";                                                                           // Extension of output file
    const char *ext_info = ".txt";                                                                      // Extension of info file
    snprintf(output_dyndiag_name, sizeof(output_dyndiag_name), "%s%s_forcedbasin", dir, outputname);            // Assign name for output file without extension
