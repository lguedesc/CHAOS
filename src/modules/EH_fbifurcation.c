...
void EH_fbifurcation(char *funcname, char* outputname, void (*edosys)(int, double *, double, double *, double *)) {
    ...
    EH_fbifurc_read_params_and_IC(input_filename, &DIM, &nPar, &maxPer, &nP, &nDiv, &trans, &t, &par, &parRange, &parIndex, &x, &nRMS, &rmsindex, &bMode);
    ...
    EH_fbifurc_print_info(output_info, DIM, nPar, maxPer, nP, nDiv, trans, t, x, par, parRange, parIndex, nRMS, rmsindex, bMode, funcname, "screen");
    EH_fbifurc_print_info(output_info, DIM, nPar, maxPer, nP, nDiv, trans, t, x, par, parRange, parIndex, nRMS, rmsindex, bMode, funcname, "file");
